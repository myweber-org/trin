...
mod tests {
    ...
    fn test_process_data_file() {
        ...
        writeln!(temp_file, "2,Test2,15.2,B").unwrap();
...
mod tests {
    ...
    #[test]
    fn test_record_validation() {
        let valid_record = DataRecord::new(1, "test".to_string(), 10.5, 123456);
        assert!(valid_record.is_valid());
    ...
    fn test_data_processor() {
        ...
        writeln!(temp_file, "3,item3,5.0,3000").unwrap();
        ...
        assert!((avg - 11.933333).abs() < 0.0001);
