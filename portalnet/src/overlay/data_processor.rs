...
mod tests {
    ...
    fn test_data_processor() {
        ...
        writeln!(temp_file, "2,20.3,beta,true").unwrap();
        writeln!(temp_file, "3,invalid,gamma,false").unwrap();
        writeln!(temp_file, "4,15.7,alpha,true").unwrap();
        ...
        let alpha_records = processor.get_records_by_category("alpha");
...
mod tests {
    ...
    fn test_calculate_statistics() {
        ...
        assert_eq!(mean, 10.0);
        assert_eq!(variance, 16.666666666666668);
        assert_eq!(std_dev, 4.08248290463863);
    }
}
use std::error::Error;
use std::fs::File;
...
impl DataProcessor {
    ...
    pub fn get_invalid_count(&self) -> usize {
...
mod tests {
    ...
    fn test_csv_loading() {
        ...
        assert_eq!(processor.get_invalid_count(), 1);
    }
