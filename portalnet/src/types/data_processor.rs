...
mod tests {
    ...
    fn test_filter_and_average() {
        ...
        processor.records.push(DataRecord::new(2, 20.0, "A".to_string(), "2024-01-02".to_string()));
        processor.records.push(DataRecord::new(3, 30.0, "B".to_string(), "2024-01-03".to_string()));
