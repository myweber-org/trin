...
mod tests {
    ...
    fn test_log_parsing() {
        ...
        writeln!(temp_file, "[2024-01-15 10:31:22] ERROR: Database connection failed").unwrap();
        writeln!(temp_file, "[2024-01-15 10:32:10] WARN: High memory usage detected").unwrap();
