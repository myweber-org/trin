...
mod tests {
    ...
    fn test_load_from_csv() {
        ...
        csv_content += "1,record1,10.5,2024-01-01\n";
        csv_content += "2,record2,20.0,2024-01-02\n";
        csv_content += "3,record3,30.5,2024-01-03\n";
    ...
    fn test_find_by_id() {
        let mut processor = DataProcessor::new();
        processor.records.push(DataRecord::new(1, "test".to_string(), 10.0, "time".to_string()));
