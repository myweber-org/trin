...
mod tests {
    ...
    fn test_data_record_validation() {
        ...
        let invalid_record = DataRecord::new(2, f64::INFINITY, "B".to_string(), "2024-01-02".to_string());
    ...
    fn test_csv_loading() {
        ...
        writeln!(temp_file, "1,100.0,TypeA,2024-01-01").unwrap();
...
mod tests {
    ...
    fn test_data_processing() {
        ...
        writeln!(temp_file, "Charlie,35,91.2").unwrap();
        ...
        assert!((mean - 91.56666666666666).abs() < 0.0001);
    }
}use csv::Reader;
...
pub fn process_data_file(file_path: &str) -> Result<Vec<Record>, Box<dyn Error>> {
    ...
    for result in reader.deserialize() {
        ...
        if record.value < 0.0 {
            eprintln!("Warning: Negative value detected for record ID {}", record.id);
        }
        records.push(record);
    }
