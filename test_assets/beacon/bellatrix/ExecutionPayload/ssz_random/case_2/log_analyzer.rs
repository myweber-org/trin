...
mod tests {
    ...
    fn test_log_analyzer() {
        ...
        writeln!(temp_file, "2024-01-15 WARN: Low memory").unwrap();
        writeln!(temp_file, "2024-01-15 ERROR: Connection failed").unwrap();
...
mod tests {
    ...
    fn test_log_analysis() {
        ...
        let mut temp_file = NamedTempFile::new().unwrap();
        writeln!(temp_file, "2023-01-01 INFO: Application started").unwrap();
        writeln!(temp_file, "2023-01-01 ERROR: Database connection failed").unwrap();
        writeln!(temp_file, "2023-01-01 WARN: High memory usage detected").unwrap();
        writeln!(temp_file, "2023-01-01 INFO: Request processed").unwrap();
