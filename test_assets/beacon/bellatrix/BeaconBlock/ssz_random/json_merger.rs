...
mod tests {
    ...
    fn test_merge_json_files() {
        ...
        let file2_content = r#"{"city": "New York", "country": "USA"}"#;
        ...
        let output_path = output_temp.path().to_str().unwrap();

        let result = merge_json_files(&[file1_path, file2_path], output_path);
        assert!(result.is_ok());
