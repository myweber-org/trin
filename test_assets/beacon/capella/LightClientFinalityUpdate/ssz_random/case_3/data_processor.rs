...
mod tests {
    ...
    fn test_cache_functionality() {
        ...
        let result1 = processor.process_dataset("test", data.clone()).unwrap();
        let result2 = processor.process_dataset("test", vec![4.0, 5.0, 6.0]).unwrap();
...
mod tests {
    ...
    fn test_data_processing() {
        ...
        assert_eq!(processor.calculate_average(), 15.416666666666666);
...
mod tests {
    ...
    fn test_validate_record() {
        ...
        let empty_record = vec!["".to_string(), "".to_string()];
