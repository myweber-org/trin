...
mod tests {
    ...
    fn test_log_analysis() {
        ...
        writeln!(temp_file, "2023-01-01 WARN: Low memory").unwrap();
        writeln!(temp_file, "2023-01-01 ERROR: Connection failed").unwrap();
        writeln!(temp_file, "2023-01-01 INFO: User logged in").unwrap();
