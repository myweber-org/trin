...
mod tests {
    ...
    fn test_xor_cipher_symmetry() {
        let cipher = XORCipher::new("secure_key_12345");
    ...
    fn test_file_encryption_decryption() {
        ...
        source_file.write_all(b"Test file content for encryption").unwrap();
        ...
        let original_content = fs::read(source_file.path()).unwrap();
