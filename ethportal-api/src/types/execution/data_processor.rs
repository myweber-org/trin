...
mod tests {
    ...
    fn test_filtering() {
        let mut processor = DataProcessor::new();
        processor.records.push(DataRecord::new(1, 10.5, "alpha".to_string()));
        processor.records.push(DataRecord::new(2, 20.3, "beta".to_string()));
        processor.records.push(DataRecord::new(3, 15.7, "alpha".to_string()));
