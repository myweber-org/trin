...
mod tests {
    ...
    fn test_process_valid_data() {
        ...
        writeln!(temp_file, "2,ItemB,-5.0,CategoryY").unwrap();
        writeln!(temp_file, "3,ItemC,20.0,CategoryZ").unwrap();
    ...
    fn test_calculate_statistics() {
        ...
        let (sum, mean, std_dev) = calculate_statistics(&test_records);
        assert_eq!(sum, 60.0);
        assert_eq!(mean, 20.0);
...
mod tests {
    ...
    fn test_csv_loading() {
        ...
        writeln!(temp_file, "3,invalid,-5.0,0").unwrap();
