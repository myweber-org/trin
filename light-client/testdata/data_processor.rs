...
mod tests {
    ...
    fn test_data_processor() {
        ...
        let unique_names = processor.get_unique_values("name");
...
impl DataProcessor {
    ...
    pub fn get_statistics(&self) -> (f64, f64, f64) {
        ...
        let avg = self.calculate_total_value() / self.records.len() as f64;
...
mod tests {
    ...
    fn test_category_stats() {
        ...
        let records = vec![
            ...
            DataRecord { id: 3, name: "R3".to_string(), value: 100.0, category: "B".to_string() },
        ];
        ...
        assert_eq!(summary.get("A"), Some(&125.0));
        assert_eq!(summary.get("B"), Some(&100.0));
    }
}