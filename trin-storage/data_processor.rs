...
mod tests {
    ...
    fn test_data_processor_operations() {
        ...
        let csv_content = "id,value,category,timestamp\n1,10.5,alpha,1000\n2,20.3,beta,2000\n3,15.7,alpha,3000\n";
        
        write!(temp_file.as_file(), "{}", csv_content).unwrap();
        
        let load_result = processor.load_from_csv(temp_file.path().to_str().unwrap());
