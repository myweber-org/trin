...
mod tests {
    ...
    fn test_process_invalid_data() {
        let mut processor = DataProcessor::new();
        let result = processor.process_numeric_data("test2", &[]);
    ...
    fn test_calculate_statistics() {
        let mut processor = DataProcessor::new();
        processor.process_numeric_data("test3", &[1.0, 2.0, 3.0]).unwrap();
        let stats = processor.calculate_statistics("test3").unwrap();
