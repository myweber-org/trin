...
mod tests {
    ...
    fn test_csv_loading() {
        ...
        writeln!(temp_file, "3,15.75,type_a").unwrap();
...
mod tests {
    ...
    fn test_processor_statistics() {
        let mut processor = DataProcessor::new();
        processor.add_record(DataRecord::new(1, 10.0, "Type1".to_string()));
        processor.add_record(DataRecord::new(2, 20.0, "Type2".to_string()));
        processor.add_record(DataRecord::new(3, -5.0, "Type1".to_string()));
